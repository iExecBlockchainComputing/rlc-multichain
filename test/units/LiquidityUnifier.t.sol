...
contract LiquidityUnifierTest is Test {
    ...
    //     _mintForUser(user, amount);
    //     // Check that tokens are minted.
    //     assertEq(rlcToken.totalSupply(), 2 * amount);
    ...
    //     // Check that tokens are minted.
    //     assertEq(rlcToken.totalSupply(), amount + amount2 + amount3);
    ...
    //     // Check that tokens are minted.
    //     assertEq(rlcToken.totalSupply(), 2 * amount + amount2 + amount3);
    ...
    //     _mintForUser(user, amount);
    //     // Check the initial state.
    //     assertEq(rlcToken.totalSupply(), amount);
    //     assertEq(rlcToken.balanceOf(user), amount);
    //     // Expect events to be emitted.
    //     vm.expectEmit(true, true, true, true);

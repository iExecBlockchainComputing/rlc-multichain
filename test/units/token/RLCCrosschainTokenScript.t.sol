...
contract RLCCrosschainTokenTest is Test {
    ...
    function test_Deploy() public {
        address crosschainTokenAddress = deployer.deploy("RLC Crosschain Token", "RLC", admin, upgrader, createx, salt);
    ...
    function test_RevertWhen_TwoDeploymentsWithTheSameSalt() public {
        ...
        deployer.deploy("RLC Crosschain Token", "RLC", admin, upgrader, createx, salt);

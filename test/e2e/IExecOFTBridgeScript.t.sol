...
import {Deploy as IExecOFTBridge} from "../../script/IExecOFTBridge.s.sol";
...
contract RLCOFTScriptTest is Test {
    ...
    function testFork_CheckDeployment() public {
        ...
        RLCOFT rlcoft = RLCOFT(deployer.deploy(tokenChainX, LAYERZERO_ENDPOINT, owner, pauser, salt));
